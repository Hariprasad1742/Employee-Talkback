...
function Nurses() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        alert('Nurses feedback submitted successfully!');
        setFormData({
          name: '',
          phone: '',
          problem: '',
        ...
        alert('Failed to submit nurses feedback');
      }
    } catch (error) {
      alert('Error submitting nurses feedback');
      console.error(error);
    }
    setLoading(false);
  };
    ...
    <div className="form-container">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <select name="difficultyType" value={formData.difficultyType} onChange={handleChange} required>
          ...
          <option value="Improper assistance">Improper assistance</option>
